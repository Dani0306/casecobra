        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            <div className="max-w-xl">
                ...
                <p className="mt-2 text-base text-zinc-500">
                    We've recieve your order and are not processing it.
                </p>
            ...
            <div className="mt-10 border-t border-zinc-200">
                <div className="mt-10 flex flex-auto flex-col">
                    ...
                    <p className="mt-2 text-sm text-zinc-600">
                        We at CaseCobra believe that a phone case does not only need to look good, 
                        but also last you for the years to come. We offer a 5-year print guarantee: 
                        If your case isn't of the highest quality. we'll replace it for free.
                    </p>
                </div>
            </div>
            ...
            <div className="space-y-6 border-t borer-zinc-200 pt-10 text-sm">
