  ...
  return (
    <div className="bg-slate-50">
      ...
      <MaxWidthWrapper className="pb-24 pt-20 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-3">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                CaseCobra allows you to protext your memories, not just your phone case.
              </p>
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">Whar our <span className="relative px-2">customers <Icons.underline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-green-500"/> </span> say</h2>
            <img src="/snake-2.png" className="w-24 order-0 lg:order-2" alt="" />
          </div>
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 ld:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
          <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "The case feels durable and I even got a compliment on the design. Had the case for two an a half months now and <span className="padding-0.5 bg-slate-800 text-white">the image is super clear</span>"
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex gap1.5 items-cetner text-zinc-600">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "I usually keep my phone together with my keys in my pocket and that led to some pretty heavey scratchmarks on all of my last phone cases. This one, besides a barely noticeable scratch on the corner <span className="padding-0.5 bg-slate-800 text-white">looks brand new after about half a year</span>"
                  , I dig it.
                </p>
              </div>
              <div className="flex gap-4 mt-2">
