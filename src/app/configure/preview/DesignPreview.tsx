    ...
    <>
        ...
        <div className="mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
            <div className="md:col-span-4 lg:col-span-3 md:row-span-2 md:row-end-2">
                <Phone className={cn(`bg-${tw}`, "max-w-[150ox] md:max-w-full")} imgSrc={configuration.croppedImageUrl!}/>
            </div>
        ...
        <div className="mt-6 sm:col-span-9 md:row-end-1">
            ...
            <div className="sm:col-span-12 md:col-span-9 text-base">
                <div className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 dm:gap-x-6 sm:py-6 md:py-10">
                    <div>
                    ...
                    <div>
                        ...
                        <ol className="mt-3 text-zinc-700 list-disc list-inside">
                            <li>Hihg-quality, durable material</li>
                            <li>Scartch- and fingerprint resistant coating</li>
                        </ol>
                    </div>
                </div>
                ...
                <div className="mt-8">
                    ...
                    <div className="mt-8 flex justify-end pb-12">
                        <Button onClick={() => handleCheckout()}  isLoading={false} loadingText="loading" className="px-4 sm:px-6 lg:px-8">Checkout <ArrowRight className="h-4 w-4 ml-1.5 inline"/></Button>
                    </div>
