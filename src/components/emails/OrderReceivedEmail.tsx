...
const OrderReceivedEmail = ({ shippingAddress, orderId, orderDate } : { shippingAddress: ShippingAddress, orderId: string, orderDate: string }) => {
    ...
    const baseUrl = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://casecobra-one-lovat.vercel.app"
        ...
        <Body style={main}>
            <Container style={container}>
                <Section style={message}>
                    ...
                    <Heading style={global.heading}>Thank your for you rorder!</Heading>
                ...
                <Section style={global.defaultPadding}>
                    <Text style={adressTitle}>
                        Shiping to: {shippingAddress.name}
                    </Text>
